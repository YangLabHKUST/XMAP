...
for (i in 1:nrep) {
  ...
  write.table(ss1, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss1_inflate_pc1_", pc_var1, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_n", n1, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt"), col.names = T, row.names = F, quote = F)

  write.table(ss2, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss2_inflate_pc1_", pc_var2, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_n", n2, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt"), col.names = T, row.names = F, quote = F)

  susiex <- paste0("export NUMEXPR_NUM_THREADS=10; export OMP_NUM_THREADS=10; python SuSiEx/SuSiEx.py --pval_thresh=1 --min_purity=0 --max_iter=500 --out_dir=/import/home/share/mingxuan/fine_mapping/simulation/susiex/output --chr=22 --bp=", bp_start - 1, ",", bp_end + 1, " --chr_col=1,1 --snp_col=2,2 --bp_col=3,3 --a1_col=4,4 --a2_col=5,5 --eff_col=6,6 --se_col=7,7 --pval_col=8,8 --keep-ambig=True --mult-step=False --maf=0.0001 --full_out=True")
  susiex <- paste0(susiex, " --n_sig=", K)
  susiex <- paste0(susiex, " --sst_file=/import/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss1_inflate_pc1_", pc_var1, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_n", n1, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                   "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt,/import/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss2_inflate_pc1_", pc_var2, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_n", n2, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                   "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt")
  ...
  susiex <- paste0(susiex, " --out_name=susiex_output_inflate_pc1_", pc_var1,"_",pc_var2, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n1, "_", n2,
