...
LD_input_file <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/input/mscaviar_LD_input_nobg_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                        "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                        "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep)
write.table(rbind(LD1_file, LD2_file),
            file = LD_input_file,
            col.names = F, row.names = F, sep = " ", quote = F)

ofile <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/output/mscaviar_output_nobg_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", 1:nrep)
z1_file <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/input/mscaviar_Zs1_nobg_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                  "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                  "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", 1:nrep)
z2_file <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/input/mscaviar_Zs2_nobg_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                  "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                  "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", 1:nrep)
z_input_file <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/input/mscaviar_Z_input_nobg_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                       "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                       "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", 1:nrep)
...
for (i in 1:nrep) {
  ...
  write.table(data.frame(SNP = z_scores1[[1]], Z_afr = z_scores1[[2]]),
              file = z1_file[i],
              col.names = F, row.names = F, sep = " ", quote = F)
  write.table(data.frame(SNP = z_scores2[[1]], Z_afr = z_scores2[[2]]),
              file = z2_file[i],
              col.names = F, row.names = F, sep = " ", quote = F)
