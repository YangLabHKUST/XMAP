...
LD_input_file <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/input/mscaviar_LD_input_inflate_pc1_", pc_var1, "_", pc_var2, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                        "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
...
ofile <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/output/mscaviar_output_inflate_pc1_", pc_var1,"_",pc_var2, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", 1:nrep)
z1_file <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/input/mscaviar_Zs1_inflate_pc1_", pc_var1, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                  "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                  "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", 1:nrep)
z2_file <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/input/mscaviar_Zs2_inflate_pc1_", pc_var2, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                  "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                  "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", 1:nrep)
z_input_file <- paste0("/home/share/mingxuan/fine_mapping/simulation/data/mscaviar/input/mscaviar_Z_input_inflate_pc1_", pc_var1,"_",pc_var2, "_corrected_loci_", i_loci, "_small_p", p, "_chr22_paintor_in_sample_n", n1, "_", n2,
                       "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                       "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", 1:nrep)
