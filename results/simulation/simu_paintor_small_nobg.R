...
fwrite(R1[idx_include, idx_include], paste0("/import/home/share/mingxuan/fine_mapping/simulation/data/paintor/working_input/paintor_mcmc_input_nobg_loci_",i_loci,"_small_p",p,"_chr22_paintor_in_sample_n", n1, "_", n2,
...
fwrite(R2[idx_include, idx_include], paste0("/import/home/share/mingxuan/fine_mapping/simulation/data/paintor/working_input/paintor_mcmc_input_nobg_loci_",i_loci,"_small_p",p,"_chr22_paintor_in_sample_n", n1, "_", n2,
                                            "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                            "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, ".LD2"),
       sep = " ", col.names = F)
...
annot <- paste0("/import/home/share/mingxuan/fine_mapping/simulation/data/paintor/working_input/paintor_mcmc_input_nobg_loci_",i_loci,"_small_p",p,"_chr22_paintor_in_sample_n", n1, "_", n2,
                "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, ".annotations")
...
zfile <- paste0("paintor_mcmc_input_nobg_loci_",i_loci,"_small_p",p,"_chr22_paintor_in_sample_n", n1, "_", n2,
                "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep)
input_file <- paste0("/import/home/share/mingxuan/fine_mapping/simulation/data/paintor/working_input/files_apaintor_mcmc_input_nobg_loci_",i_loci,"_small_p",p,"_chr22_paintor_in_sample_n", n1, "_", n2,
                     "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                     "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep)
for (i in 1:nrep) {
  ...
  z_paintor <- data.table(RSID = z_scores1[[1]], ZSCORE.P1 = z_scores1[[2]], ZSCORE.P2 = z_scores2[[2]])
