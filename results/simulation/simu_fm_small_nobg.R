...
R1_file <- paste0(
  input_folder,
  "finemap_input_nobg_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n1, "_", n2,
  "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
  "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, ".ld"
)
...
z1_file <- paste0(
  ...
  "finemap_input_nobg_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n1, "_", n2,
  "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
  "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, ".z"
)
...
for (K_true in K_all) {
  ...
  system(paste0("mkdir -p /home/share/mingxuan/fine_mapping/simulation/finemap/output/wg_n", n1, "_K", K_true, "_enrich", enrich2, "_nobg_ncausal_default"))
  output_folder <- paste0("/home/share/mingxuan/fine_mapping/simulation/finemap/output/wg_n", n1, "_K", K_true, "_enrich", enrich2, "_nobg_ncausal_default/")
  ...
  for (i in 1:nrep) {
    ...
    se <- 1 / sqrt(n1)
    z1 <- data.table(rsid = z_scores1[[1]], chromosome = rep(22, p), position = c(1:p), allele1 = rep("A", p), allele2 = rep("T", p), maf = rep(0.05, p), beta = z_scores1[[2]] * se, se = rep(se, p))
...
R2_file <- paste0(
  input_folder,
  "finemap_input_nobg_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n2,
  "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
...
z2_file <- paste0(
  input_folder,
  "finemap_input_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n2,
  "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
...
for (K_true in K_all) {
  ...
  system(paste0("mkdir -p /home/share/mingxuan/fine_mapping/simulation/finemap/output/ukb_n", n2, "_K", K_true, "_enrich", enrich2, "_nobg_ncausal_default"))
  output_folder <- paste0("/home/share/mingxuan/fine_mapping/simulation/finemap/output/ukb_n", n2, "_K", K_true, "_enrich", enrich2, "_nobg_ncausal_default/")
  ...
  for (i in 1:nrep) {
    ...
    z_scores2 <- fread(paste0("/import/home/share/mingxuan/fine_mapping/simulation/data/simu_zs2_nobg_loci_", i_loci, "_small_p", p, "_chr22_n", n2, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                              "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt"))
    se <- 1 / sqrt(n2)
    z2 <- data.table(rsid = z_scores2[[1]], chromosome = rep(29, p), position = c(1:p), allele1 = rep("A", p), allele2 = rep("T", p), maf = rep(0.05, p), beta = z_scores2[[2]] * se, se = rep(se, p))
