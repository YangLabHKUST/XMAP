...
for (i in 1:nrep) {
  ...
  ss1 <- data.frame(chr = 22, snp = snps, bp = bim_loci$V4[idx_include], a1 = bim_loci$V5[idx_include], a2 = bim_loci$V6[idx_include],
                    BETA = z_scores1$V2 / sqrt(n1), se = 1 / sqrt(n1), pval = 2 * pnorm(abs(z_scores1$V2), lower.tail = F))
  ss2 <- data.frame(chr = 22, snp = snps, bp = bim_loci$V4[idx_include], a1 = bim_loci$V5[idx_include], a2 = bim_loci$V6[idx_include],
                    BETA = z_scores2$V2 / sqrt(n2), se = 1 / sqrt(n2), pval = 2 * pnorm(abs(z_scores2$V2), lower.tail = F))

  write.table(ss1, file = paste0("/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss1_nobg_loci_", i_loci, "_small_p", p, "_chr22_n", n1, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt"), col.names = T, row.names = F, quote = F)

  write.table(ss2, file = paste0("/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss2_nobg_loci_", i_loci, "_small_p", p, "_chr22_n", n2, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt"), col.names = T, row.names = F, quote = F)
  ...
  susiex <- paste0(susiex, " --sst_file=/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss1_nobg_loci_", i_loci, "_small_p", p, "_chr22_n", n1, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                   "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt,/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss2_nobg_loci_", i_loci, "_small_p", p, "_chr22_n", n2, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                   "_enrich", enrich2, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt")
  ...
  susiex <- paste0(susiex, " --out_name=susiex_output_nobg_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n1, "_", n2,
