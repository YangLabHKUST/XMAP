...
R1_file <- paste0(
    input_folder,
    "dapg_t",df,"_new_input_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n1, "_", n2,
...
for (K_true in K_all) {
    system(paste0("mkdir -p /home/share/mingxuan/fine_mapping/simulation/dapg/output/wg_n", n1, "_K", K_true, "_enrich",enrich, "_wholeCHR_t",df,"_new_default"))
    output_folder <- paste0("/home/share/mingxuan/fine_mapping/simulation/dapg/output/wg_n", n1, "_K", K_true, "_enrich",enrich,"_wholeCHR_t",df,"_new_default")
    ...
    for (i in 1:nrep) {
        ...
        dapg <- paste0("export NUMEXPR_NUM_THREADS=", threads, "; export OMP_NUM_THREADS=", threads, "; ./dap/dap_src/dap-g -d_z ", z1_file, " -d_ld ", R1_file, " -t 10 -o ", output_folder, "/dapg.", i)
        system(dapg)
...
R2_file <- paste0(
    input_folder,
    "dapg_t",df,"_new_input_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n2,
    "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
...
for (K_true in K_all) {
    system(paste0("mkdir -p /home/share/mingxuan/fine_mapping/simulation/dapg/output/ukb_n", n2, "_K", K_true, "_enrich",enrich, "_wholeCHR_t",df,"_new_default"))
    output_folder <- paste0("/home/share/mingxuan/fine_mapping/simulation/dapg/output/ukb_n", n2, "_K", K_true, "_enrich",enrich, "_wholeCHR_t",df,"_new_default")
    ...
    for (i in 1:nrep) {
        ...
        dapg <- paste0("export NUMEXPR_NUM_THREADS=", threads, "; export OMP_NUM_THREADS=", threads, "; ./dap/dap_src/dap-g -d_z ", z2_file, " -d_ld ", R2_file, " -t 10 -o ", output_folder, "/dapg.", i)
        system(dapg)
        cat(i, "-th rep finished.\n")
    }
}
...
n1_all <- 20000#c(5000, 10000, 15000, 20000)
n2 <- 20000
K_all <- c(1, 2, 3)
...
for (K in 3) {
    for (i in c(1:50)) {
        ...
        # system(paste0('grep "((" ', "./ukb_n", n2, "_K", K, "_enrich",enrich, "_wholeCHR_t",df,"_default/dapg.", i, " > ./ukb_n", n2, "_K", K, "_enrich",enrich, "_wholeCHR_t",df,"_default/dapg_zs.", i))
        system(paste0('grep "((" ', "./ukb_n", n2, "_K", K, "_enrich",enrich, "_wholeCHR_t",df,"_new_default/dapg.", i, " > ./ukb_n", n2, "_K", K, "_enrich",enrich, "_wholeCHR_t",df,"_new_default/dapg_zs.", i))
        for (n1 in n1_all) {
            ...
            # system(paste0('grep "((" ', "./wg_n", n1, "_K", K, "_enrich",enrich, "_wholeCHR_t",df,"_default/dapg.", i, " > ./wg_n", n1, "_K", K, "_enrich",enrich, "_wholeCHR_t",df,"_default/dapg_zs.", i))
            system(paste0('grep "((" ', "./wg_n", n1, "_K", K, "_enrich",enrich, "_wholeCHR_t",df,"_new_default/dapg.", i, " > ./wg_n", n1, "_K", K, "_enrich",enrich, "_wholeCHR_t",df,"_new_default/dapg_zs.", i))
        }
    }
}