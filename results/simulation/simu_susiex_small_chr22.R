...
for (i in 1:nrep) {
  ...
  write.table(ss1, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss1_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_n", n1, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt"), col.names = T, row.names = F, quote = F)

  write.table(ss2, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss2_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_n", n2, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt"), col.names = T, row.names = F, quote = F)
  ...
  susiex <- paste0(susiex," --sst_file=/import/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss1_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_n", n1, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                            "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt,/import/home/share/mingxuan/fine_mapping/simulation/susiex/RunDirectory/ss2_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_n", n2, "_loci", i_loci, "_", "_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                            "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, "_", i, ".txt")
  ...
  susiex <- paste0(susiex," --out_name=susiex_output_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n1, "_", n2,
