...
R1_file <- paste0(
  input_folder,
  "finemap_input_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n1, "_", n2,
...
for (K_true in K_all) {
  ...
  system(paste0("mkdir -p /home/share/mingxuan/fine_mapping/simulation/finemap/output/wg_n", n1, "_K", K_true, "_enrich", enrich, "_wholeCHR_ncausal_default"))
  output_folder <- paste0("/home/share/mingxuan/fine_mapping/simulation/finemap/output/wg_n", n1, "_K", K_true, "_enrich", enrich, "_wholeCHR_ncausal_default/")
...
R2_file <- paste0(
  input_folder,
  "finemap_input_wholeCHR_loci_", i_loci, "_small_p", p, "_chr22_in_sample_n", n2,
  "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
  "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".ld"
)
...
for (K_true in K_all) {
  ...
  system(paste0("mkdir -p /home/share/mingxuan/fine_mapping/simulation/finemap/output/ukb_n", n2, "_K", K_true, "_enrich", enrich, "_wholeCHR_ncausal_default"))
  output_folder <- paste0("/home/share/mingxuan/fine_mapping/simulation/finemap/output/ukb_n", n2, "_K", K_true, "_enrich", enrich, "_wholeCHR_ncausal_default/")
