...
Beta1 <- data.matrix(fread(paste0("/import/home/share/mingxuan/fine_mapping/simulation/data/simu_loci_", i_loci, "_small_p", p, "_Beta1_t",df,"_new_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
...
Beta2 <- data.matrix(fread(paste0("/import/home/share/mingxuan/fine_mapping/simulation/data/simu_loci_", i_loci, "_small_p", p, "_Beta2_t",df,"_new_Ktrue", K_true, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                  "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".txt")))
...
saveRDS(Omega_all, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_OmegaHat_in_sample_n", n1,
                                 "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))

saveRDS(C_all, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_CHat_in_sample_n", n1,
                             "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                             "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))



saveRDS(out_xmap1, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_XMAP_bg_single1_in_sample_n", n1, "_", n2,
                                 "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))
saveRDS(out_xmap2, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_XMAP_bg_single2_in_sample_n", n1, "_", n2,
                                 "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))

saveRDS(out_xmap1_local, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_XMAP_bg_single1_local_in_sample_n", n1, "_", n2,
                                       "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                       "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))
saveRDS(out_xmap2_local, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_XMAP_bg_single2_local_in_sample_n", n1, "_", n2,
                                       "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                       "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))

saveRDS(out_xmap, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_XMAP_bg_in_sample_n", n1, "_", n2,
                                "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))

saveRDS(out_xmap_local, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_XMAP_bg_local_in_sample_n", n1, "_", n2,
                                      "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                      "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))

saveRDS(out_xmap0, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_XMAP_bg0_in_sample_n", n1, "_", n2,
                                 "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                 "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))

saveRDS(out_xmap_true, file = paste0("/import/home/share/mingxuan/fine_mapping/simulation/result/simu_t",df,"_new_WholeCHR_loci_", i_loci, "_small_p", p, "_chr22_XMAP_bg_true_in_sample_n", n1, "_", n2,
                                     "_Ktrue", K_true, "_K", K, "_Omega", h1_omega, "_", h2_omega, "_", rho_omega,
                                     "_enrich", enrich, "_rhoSigma", rho_sigma, "_nrep", nrep, ".RDS"))
